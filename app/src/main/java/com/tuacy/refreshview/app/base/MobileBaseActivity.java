package com.tuacy.refreshview.app.base;
...
import com.tuacy.refreshview.app.MobileApplication;
import com.tuacy.refreshview.widget.WaitingDialog;
...
public abstract class MobileBaseActivity extends BaseAppActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mApplication = (MobileApplication) getApplication();
	}
