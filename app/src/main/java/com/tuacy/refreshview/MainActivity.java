...
import com.tuacy.refreshview.module.table.TableRefreshActivity;
...
public class MainActivity extends MobileBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.button_table_view_refresh).setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				TableRefreshActivity.startUp(mContext);
			}
		});
	}
}
